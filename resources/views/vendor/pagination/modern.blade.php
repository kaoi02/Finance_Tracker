                ...
                <span class="relative z-0 inline-flex shadow-sm rounded-xl">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span
                                class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-400 bg-white border border-gray-100 dark:border-gray-700 cursor-default rounded-l-xl leading-5 dark:bg-gray-800">
                    ...
                    @else
                        <button wire:click="previousPage" rel="prev"
                            class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-100 dark:border-gray-700 rounded-l-xl leading-5 hover:text-gray-400 focus:z-10 focus:outline-none focus:border-primary active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150 dark:bg-gray-800 dark:text-gray-300 dark:hover:text-gray-200 dark:active:bg-gray-700"
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_string($element))
                            <span aria-disabled="true">
                                <span
                                    class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-100 dark:border-gray-700 cursor-default leading-5 dark:bg-gray-800 dark:text-gray-300">{{ $element }}</span>
                            </span>
                        @endif
                            ...
                            @foreach ($element as $page => $url)
                                ...
                                @else
                                    <button wire:click="gotoPage({{ $page }})"
                                        class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-white border border-gray-100 dark:border-gray-700 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:border-primary active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150 dark:bg-gray-800 dark:text-gray-300 dark:hover:text-gray-200 dark:active:bg-gray-700"
                    ...
                    @else
                        <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                            <span
                                class="relative inline-flex items-center px-3 py-2 -ml-px text-sm font-medium text-gray-400 bg-white border border-gray-100 dark:border-gray-700 cursor-default rounded-r-xl leading-5 dark:bg-gray-800">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
                                        clip-rule="evenodd" />
